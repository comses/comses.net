...
$(CONFIG_INI_PATH): .env $(DB_PASSWORD_PATH) ${CONFIG_INI_TEMPLATE}
...
docker-compose.yml: base.yml staging.yml ${DEPLOY_ENVIRONMENT}.yml config.mk $(DB_DATA_PATH) $(LOGS_DIR) $(PGPASS_PATH)
