...
1.  Click on the editor group at /wagtail/admin/groups/
    ...
    ![Editor group list](admin/group-list.png)

2.  Set page and object permissions to their appropriate values (only administrators should have permission to publish or delete pages)

    ![Editor group permissions](admin/group-editor-detail.png)
...
4.  Check the editors group
    ...
    ![User editor role](admin/user-edit-role.png)
