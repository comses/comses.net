...
"""
CONTENT = """
In order to be awarded an Open Code badge, all source code should be made publicly available in a searchable open access trusted digital repository. A DOI, permanent URL or other permanent digital resource locator for accessing the model code must be provided that links to the specific version of the code used in the the publication. Narrative documentation and detailed software metadata should also accompany the source code and enable others to understand the purpose of the code and ideally replicate the source code. Detailed metadata should clearly indicate all software, system, and data dependencies needed to compile and / or execute the source code including their versions. Model source code made available on an author’s personal website or via email request does not meet the criteria for an Open Code badge whereas model source code published in the CoMSES Net Computational Model Library and has successfully passed the CoMSES Net peer review process does. For a comprehensive list of repositories where model source code can be archived to meet Open Code criteria please visit our [trusted digital repositories page](https://www.comses.net/resources/trusted-digital-repositories/).

Journals participating in the Open Code program award Open Code badges to selected publications based on information provided by the authors and reviewers during the submission and review process. Online versions of publications should link the Open Code badge to the a landing page for the archived source code. If you have questions on the use of the Open Code badge, please feel free to contact us at support@comses.net.

These badges are derived from the [“Badges to Acknowledge Open Practices” project from the Open Science Framework](https://osf.io/tvyxz/) and is licensed similarly via [CC-By Attribution 4.0](https://creativecommons.org/licenses/by/4.0/)
"""
