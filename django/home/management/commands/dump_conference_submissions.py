...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for submission in submissions:
            ...
            post = create_post(id=1, author=submission.author.username, body=body, date=submission.date_created.isoformat())
            topic = create_topic(id=submission.id, author=submission.author.username, body=body,
                                 date=submission.date_created.isoformat(), category=category, posts=[post])
            topics.append(topic)
