...
from home.models import MarkdownPage, CategoryIndexPage
...
![open code html](/static/images/icons/open-code-badge.png)
"""
CONTENT = """
...
class Command(BaseCommand):
    ...
    """
    Move existing Education page from a
    """
    ...
    def handle(self, *args, **options):
        ...
        resources_page.navigation_links.filter(url='/resources/education/').delete()
