    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                choices=[('', '--'), ('markdown', 'markdown'), ('html', 'html'), ('plain', 'plain'), ('', '')],
                default='markdown', max_length=30),
        ),
        migrations.AlterField(
            model_name='journal',
            name='description',
            field=core.fields.MarkdownField(blank=True, max_length=1000, rendered_field=True),
        ),
    ]
