    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.ImageField(height_field='height', storage=django.core.files.storage.FileSystemStorage(location='/shared/library'), upload_to=wagtail.wagtailimages.models.get_upload_to, verbose_name='file', width_field='width')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submitted_package', models.FileField(null=True, upload_to=library.models.Codebase._release_upload_path)),
                ('codebase', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='releases', to='library.Codebase')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='codebaserelease',
            name='license',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='library.License'),
        ),
        migrations.AddField(
            model_name='codebaserelease',
            name='platform_tags',
            field=modelcluster.contrib.taggit.ClusterTaggableManager(help_text='A comma-separated list of tags.', through='library.CodebaseReleasePlatformTag', to='taggit.Tag', verbose_name='Tags'),
        ),
        migrations.AddField(
            model_name='codebaserelease',
            name='platforms',
        ...
        migrations.AddField(
            ...
            field=modelcluster.contrib.taggit.ClusterTaggableManager(help_text='A comma-separated list of tags.', through='library.ProgrammingLanguage', to='taggit.Tag', verbose_name='Tags'),
        ),
        migrations.AddField(
            model_name='codebaserelease',
            name='publications',
        ...
        migrations.AddField(
            model_name='codebase',
            name='latest_version',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='latest_version', to='library.CodebaseRelease'),
        ),
        migrations.AddField(
            model_name='codebase',
            name='submitter',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='codebases', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='codebase',
            name='tags',
        ...
        migrations.AlterUniqueTogether(
            name='codebaserelease',
            unique_together=set([('codebase', 'version_number')]),
        ),
    ]
