# Generated by Django 5.2.11 on 2026-03-09 21:06
...
def _get_github_config_for_default_site(apps):
    ...
    GitHubIntegrationConfiguration = apps.get_model(
        "library", "GitHubIntegrationConfiguration"
    )
...
def delete_existing_content(apps, schema_editor):
    ...
    ).objects.filter(configuration=config).delete()
...
def populate_initial_content(apps, schema_editor):
    ...
    GitHubIntegrationNewRepoInfoItem = apps.get_model(
        "library", "GitHubIntegrationNewRepoInfoItem"
    )
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("library", "0036_codebasegitremote_githubintegrationappinstallation_and_more"),
    ]
