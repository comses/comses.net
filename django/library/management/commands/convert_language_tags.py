...
programming_languages = [
    {"name": "ABS", "url": "https://www.abs-lang.org", "is_pinned": False, "aliases": []},
    {
        "name": "Assembly",
    ...
    {"name": "C", "url": "https://www.c-language.org", "is_pinned": False, "aliases": []},
    {
        "name": "C#",
    ...
    {"name": "Common Lisp", "url": "https://common-lisp.net", "is_pinned": False, "aliases": []},
    {"name": "Dart", "url": "https://dart.dev", "is_pinned": False, "aliases": []},
    {"name": "Fortran", "url": "https://fortran-lang.org", "is_pinned": False, "aliases": []},
    {"name": "Go", "url": "https://golang.org", "is_pinned": False, "aliases": []},
    {"name": "Groovy", "url": "https://groovy-lang.org", "is_pinned": False, "aliases": []},
    {"name": "Haskell", "url": "https://www.haskell.org", "is_pinned": False, "aliases": []},
    {
        "name": "Java",
    ...
    {"name": "Python", "url": "https://www.python.org", "is_pinned": True, "aliases": ["Pyton"]},
    {"name": "R", "url": "https://www.r-project.org", "is_pinned": True, "aliases": []},
    {"name": "Ruby", "url": "https://www.ruby-lang.org/en", "is_pinned": False, "aliases": []},
    {"name": "Rust", "url": "https://www.rust-lang.org", "is_pinned": False, "aliases": []},
    {"name": "Scala", "url": "https://www.scala-lang.org", "is_pinned": False, "aliases": []},
    {"name": "Shell", "url": "https://www.gnu.org/software/bash/", "is_pinned": False, "aliases": []},
    {"name": "Smalltalk", "url": "https://st.cs.uni-saarland.de", "is_pinned": False, "aliases": []},
    {
        "name": "SQL",
    ...
    {"name": "TypeScript", "url": "https://www.typescriptlang.org", "is_pinned": False, "aliases": []},
    {
        "name": "Visual Basic",
    ...
    {"name": "MATLAB", "url": "https://www.mathworks.com/products/matlab.html", "is_pinned": False, "aliases": []},
    {"name": "LPL", "url": "", "is_user_defined": True, "is_pinned": False, "aliases": ["LPL 5.55"]},
    {"name": "GAML", "url": "https://gama-platform.org", "is_pinned": False, "aliases": ["GAMA"]},
    ...
    {"name": "JSON", "url": "https://www.json.org/", "is_user_defined": True, "is_pinned": False, "aliases": []},
]
        ...
        for tag in tags:
            ...
            if programming_language_name is None:
                programming_language_name = input(
                    "Enter the programming language name for tag '{}' ({}) (blank=skip once, '!'=always skip): ".format(
                        tag.tag.name, tag.content_object.permanent_url
                    )
                ).strip()
                if programming_language_name == "!":
                    skip_forever.add(tag.tag.name)
                    logger.info("Always skipping tag '{}'".format(tag.tag.name))
                    continue
                if programming_language_name == "":
