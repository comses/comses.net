                    ...
                    <ul class="organizations">
                        <li>
                            <a href="http://www.asu.edu/" target="_blank">
                                <img src="../assets/images/logo-asu.png" alt="Arizona State University">
                            </a>
                        </li>

                        <li>
                            <a href="https://creativecommons.org/" target="_blank">
                                <img src="../assets/images/logo-cc.png" alt="Creative Commons">
                            </a>
                        </li>

                        <li>
                            <a href="http://www.nsf.gov/" target="_blank">
                                <img src="../assets/images/logo-nsf.png" alt="National Science Foundation">
                            </a>
                        </li>
                    </ul>
                </div>
