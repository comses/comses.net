...
export class UploadPage extends Vue {
  ...
  public configs = [
    ...
    },
    {
      ...
      originalInstructions:
        "Submitted narrative documentation file(s) to be placed in <project-root>/docs/",
    },
    {
      uploadType: "data",
      acceptedFileTypes: "*/*",
    ...
    },
    {
      ...
      originalInstructions:
        "Submitted model output file(s) to be placed in <project-root>/results/",
    },
  ];
  ...
  public uploadUrl(category) {
    return codebaseReleaseAPI.listOriginalsFileUrl({
      identifier: this.identifier,
      version_number: this.version_number,
      category,
    });
