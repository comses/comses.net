        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <c-check
              ...
              :check="detailProgress.programming_languages"
            ></c-check>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <p class="card-text">
              ...
              <c-check
                label="At least one narrative documentation file"
                :check="uploadProgress.docs"
              ></c-check>
              <c-check
                label="At least one input data file (optional)"
                :check="uploadProgress.data"
              ></c-check>
              <c-check
                label="At least one result file (optional)"
                :check="uploadProgress.results"
              ></c-check>
            </p>
          </div>
        </div>
...
export class Progress extends Vue {
  ...
  get detailProgress() {
    return _.mapValues(
      this.detail,
      (value, key, obj) => !_.isEmpty(value) || key === "embargo_end_date"
    );
  }
