        ...
        <div class="row">
            ...
            <div class="col-6">
                <c-datepicker v-model="end_date" name="end_date" :errorMsgs="errors.end_date" :clearButton="true"
                              :openDate="endDateOpenDate" :required="config.end_date" label="End Date"
        ...
        <div class="row">
            <div class="col-12 d-inline">
                <c-datepicker v-model="submission_deadline" name="submission_deadline"
                    ...
                    <small class="form-text text-muted" slot="help">The last day to make a submission for the event
                        (inclusive)
                    </small>
                </c-datepicker>
            </div>
